        ...
        <LayoutParameter title="SWAMP Data Dashboard" parameter={{ name: 'dissolvedOxygen', display: 'Dissolved Oxygen' }}>
            <div>
                ...
                */}
                ...
                <p>There are no statewide water quality objectives for dissolved oxygen; however, each Regional Water Quality Control Board (Regional Water Board) has established its own set of water quality objectives for DO and other parameters. These objectives, which can be region, waterbody, or site-specific, are outlined in each Regional Water Board's Water Quality Control Plan (Basin Plan).</p>
