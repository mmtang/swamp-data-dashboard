    ...
    return (
        <LayoutParameter title="SWAMP Data Dashboard" parameter={{ name: 'totalNitrogen', display: 'Total Nitrogen' }}>
            <div>
                ...
                <p>Nitrogen, like <Link to='../total_phosphorus'>phosphorus</Link>, is an essential nutrient for plants and animals. Nutrients occur naturally in freshwater and saltwater, but an overabundance of nutrients can cause excessive plant growth. The rapid growth of these plants can block sunlight from penetrating the water and also use up the <Link to='../dissolved_oxygen'>dissolved oxygen</Link> in water, depriving other oxygen-dependent organisms living in the waterbody. This condition, called eutrophication, can lead to serious public and environmental health problems such as harmful algal blooms, fish kills, and "dead zones."</p>
