    ...
    return (
        <LayoutParameter title="SWAMP Data Dashboard" parameter={{ name: 'conductivity', display: 'Conductivity' }}>
            <div>
                ...
                <p>There are no statewide water quality objectives for conductivity. A Regional Water Quality Control Board (Regional Water Board) may have region, waterbody, or site-specific water quality objectives for conductivity and other parameters. These objectives are outlined in each Regional Water Board's Water Quality Control Plan (Basin Plan).</p> 
                <h2>References</h2>
