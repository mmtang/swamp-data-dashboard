    ...
    return (
        <LayoutParameter title="SWAMP Data Dashboard" parameter={{ name: 'ph', display: 'pH' }}>
            <div>
                ...
                <p>In general, the optimal range of pH for most aquatic organisms is 6.5-8.5. The lower and/or upper limit may differ depending on the type of waterbody and species present.</p>
