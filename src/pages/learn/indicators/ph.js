    ...
    return (
        <LayoutParameter title="SWAMP Data Dashboard" parameter={{ name: 'ph', display: 'pH' }}>
            <div>
                ...
                <h2>Why is it important to measure pH?</h2>
                ...
                <p>The Regional Water Quality Control Boards (Regional Water Boards) have region and/or waterbody-specific water quality objectives for pH. These objectives are outlined in the Regional Water Boards' Water Quality Control Plans (Basin Plans).</p>
                <h2>References</h2>
