    ...
    return (
        <LayoutParameter title="SWAMP Data Dashboard" parameter={{ name: 'csci', display: 'California Stream Condition Index' }}>
            <div>
                ...
                <p>In general, CSCI scores closer to 0 indicate a degradation of biological condition based on expected/predicted condition, and scores closer to 1 indicate healthy biological condition based on expected/predicted condition. Scores greater than 1 indicate that the site has greater taxonomic richness and more complex ecological function than predicted,  given the site's natural environment setting.</p>
