    ...
    return (
        <LayoutParameter parameter={{ name: 'ecoli', display: 'E. coli' }}>
            <div>
                ...
                <p>The State Water Resources Control Board <a href="https://www.waterboards.ca.gov/bacterialobjectives/" target="_blank" rel="noreferrer noopener">bacterial objectives</a> outline the statewide water quality objectives for <i>E. coli</i> in all surface waters, enclosed bays, and estuaries that have the water contact recreational beneficial use (REC-1). For REC-1 waters where the salinity is equal to or less than 1 parts per thousand (ppth) 95 percent or more of the time:</p>
                <ul>
                    <li>Based on a statistically sufficient number of samples (not less than five samples distributed over a six-week period), the geometric mean shall not exceed <strong>100 cfu/100 mL</strong>.</li>
                    <li>If a statistically sufficient number of samples is not available to calculate the geometric mean, then no more than 10 percent of the samples collected in a calendar month shall exceed the statistical threshold value of <strong>320 cfu/100 mL</strong>.</li>
                </ul>
