...
import { chart, chartContainer, customTooltip } from '../station-page/chart.module.css';

export default function SpotStationChart({ analyte, data, extent, station }) {
    ...
    const chartId = 'station-chart-main';
    ...
    // Need to clear the svg elements from the chart before drawing again or else react will append multiple charts
    const clearChart = () => {
    ...
    const drawChart = () => {
        ...
        points.selectAll('.circle')
            ...
            .on('mouseover', function(currentEvent, d) {
                let content = '<span style="color: #a6a6a6">' + formatDate(d.SampleDate) + '</span><br>';
