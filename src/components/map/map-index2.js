...
export default function MapIndex2({ 
    ...
    // This function fetches the 2021 NLCD service and stores it in a WMSLayer object. It is toggled off by default
    const drawLandUse = () => {
        return new Promise((resolve, reject) => {
            if (mapRef) {
                ...
                .then(([WMSLayer]) => {
                    landUseLayerRef.current = new WMSLayer({
                        id: 'nlcd-layer',
                        title: 'National Land Cover Database 2021',
                        url: 'https://www.mrlc.gov/geoserver/mrlc_display/NLCD_2021_Land_Cover_L48/wms?service=WMS&request=GetCapabilities',
                        sublayers: [{
                            name: 'NLCD_2021_Land_Cover_L48',
                            title: 'Land Cover',
