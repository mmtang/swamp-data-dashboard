...
class MapIndex extends React.Component {
    ...
    initializeMap = (Map, MapView) => {
        // Change default ArcGIS JS API version to 4.16
        // 4.16 and after breaks the Search widget (submitted report to ESRI)
        setDefaultOptions({ version: '4.15' });
        this.map = new Map({
            basemap: 'gray-vector'
        });
    ...
    componentDidMount = () => {
        ...
        loadModules(['esri/Map', 'esri/views/MapView', 'esri/layers/FeatureLayer', 'esri/layers/GeoJSONLayer', 'esri/layers/MapImageLayer', 'esri/widgets/Search'], { css: true })
        .then(([Map, MapView, FeatureLayer, GeoJSONLayer, MapImageLayer, Search]) => {
